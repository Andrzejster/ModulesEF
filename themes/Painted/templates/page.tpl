	...
	<header id="site_top">
		<h1><a href="{$ADDR_SITE}" title="{$Sitename}"><img src="{$THEME_IMAGES}logo.png" alt="{$Sitename}"></a></h1>
	</header>
...
{/if}
	...
	<footer id="site_bot">
		...
		<address>Theme by <a href="http://extreme-fusion.org/" title="eXtreme-Fusion CMS">Andrzejster</a>. All right reserved.</address>
